...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bookComponent = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DisableFCDirective = exports.BookFormComponent = undefined;

	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

	var _dec, _class, _dec2, _dec3, _dec4, _class2, _desc, _value, _class3, _descriptor;
	...
	var _book_formPartial = __webpack_require__(68);
	...
	var DisableFCDirective = exports.DisableFCDirective = (_dec2 = (0, _core.Directive)({
	  selector: '[disableFC][disableCond]'
	}), _dec3 = (0, _core.Input)(), _dec4 = (0, _core.Input)('disableCond'), _dec2(_class2 = (_class3 = function () {
	  function DisableFCDirective() {
	    _classCallCheck(this, DisableFCDirective);

	    _initDefineProp(this, 'disableFC', _descriptor, this);
	  }

	  _createClass(DisableFCDirective, [{
	    key: 'disableCond',
	    get: function get() {
	      // getter, not needed, but here only to completude
	...
	}(), (_descriptor = _applyDecoratedDescriptor(_class3.prototype, 'disableFC', [_dec3], {
	  enumerable: true,
	  initializer: function initializer() {
	    return this.disableFC;
	  }
	}), _applyDecoratedDescriptor(_class3.prototype, 'disableCond', [_dec4], Object.getOwnPropertyDescriptor(_class3.prototype, 'disableCond'), _class3.prototype)), _class3)) || _class2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CORE_DECLARATIONS = exports.CORE_DECLARATIONS = [_book.BookComponent, _book.ReturnMonthYearPipe, _book_form.BookFormComponent, _book_form.DisableFCDirective, _app.AppComponent];
